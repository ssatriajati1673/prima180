...
class Penilaian extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $data['pegawai'] = $this->Penilaian_model->get_data('penilaian_pns')->result();

        $data['all_data'] = $this->Penilaian_model->get_data('penilaian_pns');
    ...
    function load_data()
    {
        $data = $this->Penilaian_model->load_data();
    ...
    function update()
    {
        ...
        $this->Penilaian_model->update($data, $this->input->post('id'));
    }
